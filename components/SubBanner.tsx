...
const SubBanner = () => {
	return <div className="flex relative w-full h-96">
			<Image src={"/subbanner/1.png"} alt="subBanner" width={1000} height={1000} className="object-cover w-full h-full absolute left-0 top-0" />
			<div className="absolute left-[32%] md:left-[40%] lg:left-[50%] top-[55%] lg:top-[50%] translate-x-[-50%] translate-y-[-50%] w-full flex flex-col items-center justify-center lg:pl-40 ">
				...
				<div className="flex gap-4 w-1/2 lg:w-3/4 justify-center pl-36 pt-12 lg:pl-44">
					<input type="text" placeholder="Your email address" className="py-2 px-4 rounded-lg bg-white w-24 sm:w-fit " />
